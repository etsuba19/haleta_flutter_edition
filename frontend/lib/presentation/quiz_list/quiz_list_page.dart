...
import '../add_quiz/add_quiz_page.dart';
...
class QuizListPage extends ConsumerWidget {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: _buildQuizRow(context, quiz, index, ref),
                        );
                      },
                    ),
                  ),
  ...
  Widget _buildQuizRow(
      BuildContext context, Quiz quiz, int index, WidgetRef ref) {
    return Container(
            ...
            children: [
              ...
              Padding(
                ...
                child: _buildInnerButton(
                  ...
                  textColor: const Color(0xFFF5E8EA),
                  onPressed: () {
                    ref.read(quizListProvider.notifier).removeQuiz(quiz.id);
                  },
                ),
              ),
            ],
